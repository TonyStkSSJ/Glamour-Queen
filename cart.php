    ...
    if(isset($_GET['id'])){
      ...
      for($i=0;$i<count($arreglo);$i++){
        ...
        if($encontro==true){
          ...
          $precio="";
          $imagen="";
          $res=$conexion->query('select * from productos where id='.$_GET['id'])or die($conexio->error);
...
<html lang="en">
  <head>
    <title>Glamour Queen - Carrito</title>
    <meta charset="utf-8">
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Proceder con el Pedido</button>
                  </div>
                </div>
              </div>
            </div>
